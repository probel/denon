        ...
        <div class="col-xl-10 mx-auto px-0">
            <div class="article-page__content">
                <div class="article-page__content__title__wrapper d-flex align-items-baseline justify-content-between">
                    <h2 class="article-page__content__title text-uppercase">ПРОИГРЫВАТЕЛЬ ВИНИЛОВЫХ ДИСКОВ DP-400</h2>
                    <div class="article-page__content__date">12.02.2020</div>
                </div>
                <div class="article-page__content__text">
                    <img src="/images/project/news-1.jpg" alt="">
                    <p>Виниловые пластинки сегодня - это философия, предмет коллекционирования и выбор энтузиастов хорошего звука.
                        Проигрыватель виниловых дисков стал знаковым элементом современного интерьера. Появившись в квартире, он формирует
                        вокруг себя своеобразную атмосферу. А коллекция дисков становится культурным центром всего дома, добавляя магии в
                        ритуал прослушивания музыки.</p>
                    <p>Виниловые пластинки сегодня - это философия, предмет коллекционирования и выбор энтузиастов хорошего звука.
                        Проигрыватель виниловых дисков стал знаковым элементом современного интерьера. </p>
                    <h3>Простая настройка и использование</h3>
                    <p>Виниловые пластинки сегодня - это философия, предмет коллекционирования и выбор энтузиастов хорошего звука.
                        Проигрыватель виниловых дисков стал знаковым элементом современного интерьера. Появившись в квартире, он формирует
                        вокруг себя своеобразную атмосферу. А коллекция дисков становится культурным центром всего дома, добавляя магии в
                        ритуал прослушивания музыки.</p>
                    <img src="/images/project/news-2.jpg" alt="">
                    <p>Виниловые пластинки сегодня - это философия, предмет коллекционирования и выбор энтузиастов хорошего звука.
                        Проигрыватель виниловых дисков стал знаковым элементом современного интерьера. Появившись в квартире, он формирует
                        вокруг себя своеобразную атмосферу. А коллекция дисков становится культурным центром всего дома, добавляя магии в
                        ритуал прослушивания музыки.</p>
                ...
                <a href="#" class="article-page__content__big-link text-center text-uppercase">ПОСМОТРЕТЬ МОДЕЛИ ВИНИЛОВЫХ ПРОИГРЫВАТЕЛЕЙ</a>
            </div>
        </div>
    </div>
</div>
