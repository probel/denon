        ...
        <form action="{{ route('order.quick') }}/" method="POST" class="col-lg-8 px-0 mx-auto quick__form js-order__quick">
            <div class="row">
                <div class="col-sm-6 order-1">
                    <div class="form-group position-relative">
                        ...
                        <div class="form-control__wrapper">
                            <input class="form-control" id="quick-form-name" type="text" name="name" placeholder="Введите имя">
                        </div>
                ...
                <div class="col-sm-6 order-2">
                    <div class="form-group position-relative">
                        <label class="form-label" for="quick-form-phone">Ваш телефон <span class="color-red">*</span></label>
                        <div class="form-control__wrapper">
                ...
                <div class="col-sm-6 order-4 order-sm-3">
                    <a href="/" class="btn btn-light ml-auto">Вернуться на сайт</a>
                </div>
