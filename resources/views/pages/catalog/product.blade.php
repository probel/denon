...
<div class="product-page position-relative">
    <div class="container">
        ...
        <div class="product-card">
            <div class="row">
                <div class="col-lg-6">
                    <h2 class="main-title d-lg-none text-center">{!! rv($product->name) !!}</h2>
                    <div class="photo-big__wrapper position-relative h-100">
                        <div class="photo-big h-100">
                            ...
                            <div class="photo-big__item">
                                <a href="{{ asset($image) }}" class="d-flex h-100" data-lightbox="product-{{ $product->id }}">
                                    <img class="m-auto img-fluid" src="{{ asset($image) }}" alt="{{ rv($product->getAlt($key)) }}">
                                </a>
                            </div>
                            @endforeach
                        </div>
                        {{-- <div class="photo-big__numbers position-absolute">
                            ...
                            <span class="total">/{{ count($product->images ?? []) > 9 ? '' : '0'  }} {{ count($product->images ?? []) }}</span>
                        </div> --}}
                    </div>
                </div>
                <div class="col-lg-6">
                    <h1 class="main-title d-none d-lg-block">{!! rv($product->name) !!}</h1>
                    <form action="{{ route('cart.set') }}/" method="post" class="product-card__form js-form__to-cart">
                        ...
                        <div class="d-flex align-items-center plusminus__wrapper">
                            ...
                            @if ($product->getPrice(0))
                                <div class="old-price align-self-end">{{ number_format($product->getPrice(0),0,'.',' ') }}<span class="currency"> {{ currency() }}</span></div>
                            @endif
                        </div>
                        <div class="d-flex product-card__form__buttons justify-content-between flex-wrap">
                            ...
                            <a class="btn btn-light js-quick-btn" data-id="{{ $product->id }}" href="{{ route('quick',['id'=>$product->id]) }}">Быстрый заказ</a>
                        </div>
                    </form>
                    <div class="row">
        ...
        <div class="product-description">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane {{ ($product->description || $product->feature) ? 'fade' : 'active' }}" id="product-desc-03">
                    ...
                    @foreach ($product->reviews->where('status',1)->sortBy('order') as $review)
                    <div class="product-description__review {{ $loop->last ? 'last' : '' }}">
                        <div class="col-xl-8 col-lg-10 px-lg-0 mx-auto">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <div class="review__date">{{ $review->created_at ? $review->created_at->format('d.m.Y') : '' }}</div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group position-relative">
                                        <label class="form-label" for="review-form-name">Ваше имя <span class="color-red">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group position-relative">
                                        <label class="form-label" for="review-form-tel">Ваш телефон <span class="color-red">*</span></label>
                                        <div class="form-control__wrapper">
                    ...
                    <div class="col-xl-8 col-lg-10 px-0 mx-auto">
                        <form action="{{ route('questions.add') }}/" method="POST" class="review__form js-review__form1">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group position-relative">
                                        <label class="form-label" for="questions-form-name">Ваше имя <span class="color-red">*</span></label>
                                        <div class="form-control__wrapper">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group position-relative">
                                        <label class="form-label" for="questions-form-email">Ваш e-mail <span class="color-red">*</span></label>
                                        <div class="form-control__wrapper">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group position-relative">
                                        <label class="form-label"
                                                for="questions-form-message">Ваш вопрос <span class="color-red">*</span>
                                        </label>
                                        <div class="form-control__wrapper">
                                            <textarea class="form-control textarea"
