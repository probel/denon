<div class="container">
    <h2 class="main-title text-center my-5"><strong>Комментарии</strong></h2>
    ...
    <div class="col-xl-7 col-lg-10 mx-auto px-0">
        <form action="{{ route('comments.add') }}/" method="POST" class="review__form js-review__form">
            <h3 class="main-title text-center">Оставить комментарий</h3>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group position-relative">
                        <label class="form-label" for="review-form-email">Ваш e-mail <span class="color-red">*</span></label>
                        <div class="form-control__wrapper">
                ...
                <div class="col-lg-12">
                    <div class="form-group position-relative">
                        <label class="form-label"
                                for="review-form-message">Ваш комментарий <span class="color-red">*</span>
                        </label>
                        <div class="form-control__wrapper">
